...
const key = 'updatable';
const newServer = `${server}/event/ourArticles`
...
//   if(!editorState){
    ...
    return(
        ...
        <FormItem label='Article title' Textarea='Aextarea' height="70px" name='title' />
        {/* <FormItem label='Article Detail' name='detail' Textarea='Textarea' height='300px' /> */}
