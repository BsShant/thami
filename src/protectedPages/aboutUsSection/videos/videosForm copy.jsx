...
const OurPartnersForm = (props)=>{
  ...
  let imageHolder= props.value? `${server}/${props.value.image}` : ImagePlaceholder
    ...
    return(
        ...
        <FormItem Textarea='Textarea' height='70px'  label='Video Title' name='title' />
        <FormItem label='Video Detail' name='detail' Textarea='Textarea' height='120px' />
        {/* <FormItem Textarea='Textarea' height='70px' label='Position' name='position' /> */}
        <input id="videoFile" type="file" name='video' onChange={videoFileChange} style={{marginBottom:"50px"}} accept='video/*'/>
