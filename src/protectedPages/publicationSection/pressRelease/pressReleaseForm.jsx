...
const key = 'updatable';
const newServer = `${server}/publication/pressRelease`
...
//   if(!editorState){
    ...
    return(
        ...
        <FormItem Textarea='TextArea' height="70px"  label='Press Release title' name='title' />
        {/* <FormItem  label='Press Release Detail' name='detail' Textarea='Textarea' height='300px' /> */}
