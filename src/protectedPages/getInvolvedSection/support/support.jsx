...
const newServer=`${server}/getInvolved/supportImageSection`
const OurStory = ()=>{
  ...
  const parsedToken = useSelector(state=>state.authStore.userToken)
    ...
    const onFinish = async(values) => {
        ...
        try {
          const res = await fetch(`${server}/getInvolved/supportTextSection`, {
            method: 'PUT', 
    ...
    return(
        ...
        <PageHeading value={supportPageHeading} headingServer='getInvolved/supportPageHeader' imageServer='getInvolved/supportPageImage' />
        </div>
        <div className="col-md-12 " style={{marginBottom:"70px"}}>
        <h3>Support Us section</h3>
        <div className="row">
        ...
        <div className="imageBox">
          <h3>Support Us Image</h3>
        <ImageSend 
        value={supportSection? supportSection.image : null}
