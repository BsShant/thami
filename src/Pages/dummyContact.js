...
const ContactUs = (props) => {
  return (
    ...
    //     >
      ...
      >
        {props.Textarea?
        <Input.TextArea style={{height:`${props.height? props.height:'auto'}`, borderRadius:"5px", background:`${props.frontContact? 'rgba(255,255,255,0.4)' : 'white'}`,color: "black"}}/>
        :
          <Input style={{height:`${props.height? props.height:'auto'}`,background:`${props.frontContact? 'rgba(255,255,255,0.4)' : 'white'}`,
          color: "black"}} />
        }
        </Form.Item>
        // </Form>
